...
export function AgentToolsPlaceholder() {
  return (
    <div className="h-64 flex flex-col items-center justify-center text-neutral-400 border rounded-lg border-dashed">
      <Wrench className="h-10 w-10 mb-4" />
      <h3 className="text-lg font-medium text-neutral-600">Coming Soon</h3>
